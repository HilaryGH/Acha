  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        {/* Section Header with Left-Aligned Search */}
            ...
            <div className="lg:w-96">
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm shadow-sm hover:shadow-md transition-shadow"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {(searchQuery || locationFilter) && (
              <button
                ...
                className="px-4 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl font-medium transition-colors text-sm whitespace-nowrap shadow-sm hover:shadow-md"
              >
                Clear Filters
              </button>
            )}
